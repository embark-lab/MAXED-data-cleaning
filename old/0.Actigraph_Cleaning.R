...
g.shell.GGIR(
  mode = c(1,2,3,4,5), #run non-sleep related GGIR parts
  datadir = "data/Actigraph/RAW", 
  outputdir ="data/Actigraph/GGIR_output",
  do.report = c(1,2,5), #include report for parts 2 and 5
  ...
  # part 3+4
  #==============
  #not running sleep analyses
  
  #=================
  #Part 5
  #=================
  
  #Selected 3 common thresholds based on literature
  #PMCID
  #PMCID 
  #PMCID
  
  threshold.lig = c (40, 217, 44.8), 
  threshold.mod = c (100, 645, 100.6), 
  threshold.vig = c (400, 1810, 428.8),
  
  #light, mod, vig thresholds: 40, 100, 400 - default
  #light, mod vig thresholds: 217, 645, 1810 - Esliger et al. 2011
