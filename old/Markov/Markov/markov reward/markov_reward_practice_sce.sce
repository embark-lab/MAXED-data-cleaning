...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_P1.jpg";};
        x = 0;  y = 0;
		  } instructions;
   code = "instructions";
...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_P2.jpg";};
        x = 0;  y = 0;
		  } instructions_2;
   code = "instructions_2";
   response_active = true;
...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_P3.jpg";};
        x = 0;  y = 0;
		  } instructions_3;
   code = "instructions_3";
   response_active = true;
...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_P4.jpg";};
        x = 0;  y = 0;
		  } instructions_4;
   code = "instructions_4";
   response_active = true;
...
bitmap { filename = "P_S1_L.jpg";}S1_L_bit;
bitmap { filename = "P_S1_R.jpg";}S1_R_bit;

#change these to add boxes
bitmap { filename = "P_S1_L_box.jpg";}S1_L_box_bit;
bitmap { filename = "P_S1_R_box.jpg";}S1_R_box_bit;
...
bitmap { filename = "P_S2_L_L.jpg";}S2_L_L_bit;
bitmap { filename = "P_S2_L_R.jpg";}S2_L_R_bit;
bitmap { filename = "P_S2_R_L.jpg";}S2_R_L_bit;
bitmap { filename = "P_S2_R_R.jpg";}S2_R_R_bit;

#change these to add boxes
bitmap { filename = "P_S2_L_L_box.jpg";}S2_L_L_box_bit;
bitmap { filename = "P_S2_L_R_box.jpg";}S2_L_R_box_bit;
bitmap { filename = "P_S2_R_L_box.jpg";}S2_R_L_box_bit;
bitmap { filename = "P_S2_R_R_box.jpg";}S2_R_R_box_bit;
...
bitmap { filename = "coin_win.jpg";}coin_win_bit;
bitmap { filename = "coin_no_win.jpg";}coin_no_win_bit;
...
sub stage1 begin;
	...
	fixationTrial.set_duration(random(2000,4000));
	...
	stage1_trial.set_duration(random(750,1500));#present with box around chosen option
	...
	stage1_outcome_trial.set_duration(random(750,1500));
...
sub stage2 begin;	
	...
	stage2_trial.set_duration(random(750,1500));#put box around chosen option
	...
	stage2_up_trial.set_duration(random(750,1500));
   ...
   #determine the outcome of stage 2
	...
	stage2_outcome_trial.set_duration(random(1000,2000));
...
prob_arrays.open("prob_arrays_"+sub_id+".txt", file_append, false);
...
fixationTrial.set_duration(random(500,1500));
fixationTrial.present();

loop int trial_loop = 1 until trial_loop > 10
begin;
