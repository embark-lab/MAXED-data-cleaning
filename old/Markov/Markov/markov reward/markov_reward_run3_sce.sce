...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_1.jpg";};
        x = 0;  y = 0;
		  } instructions;
   code = "instructions_1";
...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_2.jpg";};
        x = 0;  y = 0;
		  } instructions_2;
   code = "instructions_2";
   response_active = true;
...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_3.jpg";};
        x = 0;  y = 0;
		  } instructions_3;
   code = "instructions_3";
   response_active = true;
...
trial {    
   ...
   trial_type = specific_response; 
	terminator_button = 3;              
   picture { 
  		  bitmap { filename = "Markov_Reward_Task_Instructions_4.jpg";};
        x = 0;  y = 0;
		  } instructions_4;
   code = "instructions_4";
   response_active = true;
...
bitmap { filename = "S1_L_rv.jpg";}S1_L_bit;
bitmap { filename = "S1_R_rv.jpg";}S1_R_bit;

#change these to add boxes
bitmap { filename = "S1_L_box_rv.jpg";}S1_L_box_bit;
bitmap { filename = "S1_R_box_rv.jpg";}S1_R_box_bit;
...
bitmap { filename = "S2_L_L_rv.jpg";}S2_L_L_bit;
bitmap { filename = "S2_L_R_rv.jpg";}S2_L_R_bit;
bitmap { filename = "S2_R_L_rv.jpg";}S2_R_L_bit;
bitmap { filename = "S2_R_R_rv.jpg";}S2_R_R_bit;

#change these to add boxes
bitmap { filename = "S2_L_L_box_rv.jpg";}S2_L_L_box_bit;
bitmap { filename = "S2_L_R_box_rv.jpg";}S2_L_R_box_bit;
bitmap { filename = "S2_R_L_box_rv.jpg";}S2_R_L_box_bit;
bitmap { filename = "S2_R_R_box_rv.jpg";}S2_R_R_box_bit;
...
loop int trial_loop = 1 until trial_loop > 83
begin;
